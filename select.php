...
$sql = "SELECT id, f_name, l_name, fa_name, n_code, username , pas FROM stude ORDER BY id DESC";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // اینجا نام کاربری لینک شده به صفحه نمره گذاری
        echo '<td><a href="grades.php?user=' . urlencode($row['username']) . '">' . htmlspecialchars($row['username']) . '</a></td>';
        echo "</tr>";
    }
